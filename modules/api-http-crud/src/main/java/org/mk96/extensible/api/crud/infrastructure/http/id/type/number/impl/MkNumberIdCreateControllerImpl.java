...
import org.mk96.extensible.api.crud.infrastructure.http.id.type.number.MkNumberIdCreateController;
...
@NoArgsConstructor
public class MkNumberIdCreateControllerImpl<REQ extends MkRequestDto, DOM extends MkDomain, RES extends MkResponseDto, ID extends Number>
	extends AbstractMkController<REQ, DOM, RES>
	implements MkNumberIdCreateController<REQ, DOM, RES, ID> {

	@Autowired
	protected MkIdCreateService<DOM, ID> service;

	public MkNumberIdCreateControllerImpl(
