...
public class MkNullUniqueFilterException extends MkCrudException {

	private static final long serialVersionUID = 1L;
	
	private static final String NULL_ID_MESSAGE = 
			"Can not build unique filter cos all unique fields are null";
	
	public MkNullUniqueFilterException(List<Field> fields) {
